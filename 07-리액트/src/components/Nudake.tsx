...
import image1 from '../assets/nudake-1.jpeg';
import image2 from '../assets/nudake-2.jpeg';
import image3 from '../assets/nudake-3.jpeg';
import {
  drawImageCenter,
  getAngle,
  getDistance,
      ...
      return new Promise((resolve) => {
        ...
        imageSrcs.forEach((src) => {
          ...
          img.onload = () => {
            ...
            if (loaded === imageSrcs.length) return resolve(true);
          };
        });
      });
    }
